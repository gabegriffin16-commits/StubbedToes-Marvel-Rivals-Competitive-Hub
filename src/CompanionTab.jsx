...
const DOWNLOAD_URL = "https://github.com/gabegriffin16-commits/StubbedToes-Marvel-Rivals-Competitive-Hub/releases/download/companion-v1.0.1/StubbedToes-Companion-Setup-1.0.0.exe";
const VERSION = "1.0.0";
