...
const COMPS=[
{name:"DRAFT",tag:"Overall Draft Suggestions",color:C.gold,desc:"Our universal ban/save philosophy across all comps. Ban priority: Elsa Bloodstone first (S+ DPS, game-warping when unbanned — if she's open, the enemy takes her and builds around her). Deadpool (V) second (S+ tank, most flexible Vanguard in the game — removing him limits enemy tank options and forces predictable frontlines). Third ban is context-dependent based on which comp YOU are running. Saves should always protect your comp's keystone hero — the one hero whose removal collapses the entire strategy. If you don't know what to save, save Magneto (Gabe's 71.4% WR and the backbone of 6+ of our comps).",
lineup:[],tu:[],alt:"",
bs:{b:[{h:"Elsa Bloodstone",w:"ALWAYS FIRST BAN. S+ DPS. Game-warping when open. Enemy will build around her if unbanned."},{h:"Deadpool (V)",w:"ALWAYS SECOND BAN. S+ tank. Most flexible Vanguard. Removing him forces enemy into predictable frontlines."},{h:"Context Ban",w:"3rd ban depends on YOUR comp: C&D (if not running it), Gambit (highest-impact ult), Spider-Man (if running anti-dive), or Venom (to prevent enemy dive)."}],s:[{h:"Magneto",w:"Default save. Backbone of 6+ comps. Gabe's 71.4% WR. If banned, half our playbook collapses."},{h:"Comp Keystone",w:"Save whichever hero is central to your chosen comp — Groot for poke, Venom for dive, Thor for brawl. Protect the strategy, not just the player."},{h:"C&D",w:"If running it (Raquel primary). Save denies enemy AND secures your heals. Multiple pilots available as backup."}]}},
{name:"POKE A",tag:"Double Shield",color:C.blue,desc:"Primary poke composition. Groot wall + Magneto shield = fortress. S7's 20% ult nerf stretches neutral phases to 50+ seconds, which means base kit value matters enormously.",
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Wall control. Planet X Pals w/ Rocket."},{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Metal Bulwark."},{p:"Tristen",h:"Hela",r:"dps",n:"Primary ranged hitscan. Goddess of Death ult."},{p:"Jace",h:"Daredevil",r:"dps",n:"72% WR 4.32 KDA. Wallhack = permanent team info."},{p:"Ayden",h:"Rocket",r:"heal",n:"Planet X Pals w/ Groot."},{p:"Raquel",h:"C&D",r:"heal",n:"12.82 KDA. C&D priority."}],tu:["Planet X Pals (Groot+Rocket)"],alt:"Groot banned: Begin Thor. Mag banned: Gabe Strange. Jace out: Zach Daredevil.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Venom",w:"Prevent enemy dive into poke line."}],s:[{h:"Magneto",w:"Poke collapses without bubble."},{h:"Groot",w:"Wall control is the comp's foundation."}]}},
{name:"POKE B",tag:"1-2-3 Triple Heal",color:C.blue,desc:"Triple-support poke. 1-2-3 dominant at Diamond+. Gabe on Ultron heals (58.3% WR, 8.75 KDA) provides aerial anti-dive as 3rd support.",
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Solo tank anchor."},{p:"Tristen",h:"Hela",r:"dps",n:"Primary poke DPS."},{p:"Jace",h:"Daredevil",r:"dps",n:"72% WR. Info DPS."},{p:"Ayden",h:"Jeff",r:"heal",n:"10.86 KDA — best healer stats on roster."},{p:"Gabe",h:"Ultron",r:"heal",n:"58.3% WR 8.75 KDA. Aerial anti-dive 3rd support."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority. 12.82 KDA."}],tu:["Planet X Pals (Groot+Jeff)"],alt:"Gabe not on Ultron: Sam Rocket. Raquel banned off C&D: Sam C&D backup.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Spider-Man",w:"Deny enemy dive into triple-support."}],s:[{h:"Groot",w:"Solo tank = if banned, comp dies."},{h:"C&D",w:"Save denies enemy AND secures Raquel."}]}},
{name:"BRAWL A",tag:"Thor Rush",color:C.accent,desc:"Begin's Thor (70% WR) is the team's most proven hero. Gabe's Magneto bubble protects the push. Ayden on Gambit enables Explosive Entanglement while providing AoE heals for the deathball.",
lineup:[{p:"Begin",h:"Thor",r:"tank",n:"70% WR. Primary engage."},{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Bubble protects the push. Explosive Entanglement w/ Gambit."},{p:"Tristen",h:"Psylocke",r:"dps",n:"Melee flanker. Backstabs during engage."},{p:"Zach",h:"Wolverine",r:"dps",n:"S-tier sustained melee."},{p:"Ayden",h:"Gambit",r:"heal",n:"Explosive Entanglement w/ Magneto."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority. Position BEHIND the brawl."}],tu:["Explosive Entanglement (Gambit+Magneto)"],alt:"Jace Blade for Zach/Tristen. T-Money Angela on corridor maps.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"C&D",w:"Deny enemy healing anchor."}],s:[{h:"Thor",w:"The comp IS Thor."},{h:"Magneto",w:"Bubble enables the brawl push."}]}},
{name:"BRAWL B",tag:"Rogue Drain",color:C.accent,desc:"Rogue's ult drain devastates S7's slower ult economy. Gambit's Explosive Entanglement amplifies. This comp wins by destroying the enemy's ult economy.",
lineup:[{p:"Gabe",h:"Rogue",r:"tank",n:"Ult drain punishes slow S7 ult charge."},{p:"Begin",h:"Thor",r:"tank",n:"70% WR. Brawl monster."},{p:"Tristen",h:"Psylocke",r:"dps",n:"Melee flanker."},{p:"Zach",h:"Wolverine",r:"dps",n:"Sustained melee."},{p:"Ayden",h:"Gambit",r:"heal",n:"Explosive Entanglement w/ Rogue."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority."}],tu:["Explosive Entanglement (Gambit+Rogue)"],alt:"Rogue banned: Gabe Magneto. Jace Blade for Zach.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Gambit",w:"If enemy bans Gambit, save Rogue harder."}],s:[{h:"Rogue",w:"Ult drain IS the strategy."},{h:"Gambit",w:"Explosive Entanglement requires both."}]}},
{name:"DIVE A",tag:"Magik Core",color:C.purple,desc:"Begin's Magik (100% WR 9g) + Ayden's Venom. Gabe anchors on Magneto — bubble provides safe regrouping after dive attempts. Highest-ceiling comp on the roster.",
lineup:[{p:"Ayden",h:"Venom",r:"tank",n:"ONLY dive tank. +150 HP Symbiote Shenanigans."},{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Bubble = safe regrouping after dives."},{p:"Begin",h:"Magik",r:"dps",n:"100% WR 9g. Portal pressure."},{p:"Tristen",h:"Spider-Man",r:"dps",n:"78.6% WR. MUST dive WITH Venom, not solo."},{p:"Zach",h:"Gambit",r:"heal",n:"8.50 KDA. AoE heals."},{p:"Raquel",h:"C&D",r:"heal",n:"Teleport. C&D priority."}],tu:["Symbiote Shenanigans (Venom+Hela)"],alt:"Venom banned: Dive is dead. Jace Blade for Zach.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Groot",w:"Enemy wall blocks dive lanes."}],s:[{h:"Venom",w:"Dive dies without Venom."},{h:"Magneto",w:"Bubble is the safety net."}]}},
{name:"DIVE B",tag:"Triple Heal Dive",color:C.purple,desc:"1-2-3 dive variant. Tristen on Luna Snow (5.00 KDA in only win). Gabe anchors on Magneto for stability while dive operates around him.",
lineup:[{p:"Ayden",h:"Venom",r:"tank",n:"Dive initiator."},{p:"Gabe",h:"Magneto",r:"tank",n:"Anchor. Bubble protects Luna heals."},{p:"Begin",h:"Magik",r:"dps",n:"Primary dive assassin."},{p:"Tristen",h:"Luna Snow",r:"heal",n:"5.00 KDA in the only win."},{p:"Zach",h:"Wolverine",r:"dps",n:"Follow-up dive DPS."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority."}],tu:["Blessing of Kumiho (WF+Luna — future)"],alt:"Raquel to White Fox for Kumiho. T-Money Peni as 2nd tank variant.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"C&D",w:"Deny enemy heals if not saving."}],s:[{h:"Venom",w:"Dive dies without Venom."},{h:"Luna Snow",w:"Tristen's flex. Losing Luna loses triple-heal."}]}},
{name:"ANTI-DIVE A",tag:"Groot Fortress",color:C.green,desc:"Punish enemy dive. Groot walls block dive lanes. Daredevil spots flankers. Rogue drains ult charge divers need.",
lineup:[{p:"Gabe",h:"Rogue",r:"tank",n:"Ult drain devastates divers."},{p:"Begin",h:"Groot",r:"tank",n:"Walls block dive lanes."},{p:"Tristen",h:"Hela",r:"dps",n:"Punishes from range."},{p:"Jace",h:"Daredevil",r:"dps",n:"72% WR. Wall-hack spots dives."},{p:"Ayden",h:"Gambit",r:"heal",n:"Explosive Entanglement w/ Rogue."},{p:"Sam",h:"Rocket",r:"heal",n:"66.7% WR. Planet X Pals."}],tu:["Explosive Entanglement (Gambit+Rogue)","Planet X Pals (Groot+Rocket)"],alt:"Groot banned: Begin Thor. Rogue banned: Gabe Magneto.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Venom",w:"Ban dive tank so they CAN'T dive."}],s:[{h:"Groot",w:"Wall control is the anti-dive foundation."},{h:"Rogue",w:"Ult drain is the weapon."}]}},
{name:"ANTI-DIVE B",tag:"Shield Stack",color:C.green,desc:"Magneto bubble + Strange portal = most survivable backline. Strange portals team to safety, Magneto shields the landing, DPS shreds overextended divers.",
lineup:[{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Metal Bulwark."},{p:"Begin",h:"Dr. Strange",r:"tank",n:"Portal repositions. 10.75 KDA ceiling game."},{p:"Tristen",h:"Hela",r:"dps",n:"Ranged damage from safety."},{p:"Jace",h:"Daredevil",r:"dps",n:"72% WR. Info tracking."},{p:"Ayden",h:"Jeff",r:"heal",n:"10.86 KDA. Best healer stats."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority."}],tu:["Arcane Order (Strange+SW — partial)"],alt:"Raquel out: Sam C&D backup.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Venom",w:"Ban dive tank to protect shields."}],s:[{h:"Magneto",w:"Shield stack requires Magneto."},{h:"Dr. Strange",w:"Portal is the escape. Losing Strange = no repositioning."}]}},
{name:"HYBRID: Poke/Dive",tag:"Flex Engage",color:C.gold,desc:"Poke 80%, dive for the kill. Spider-Man dives weakened targets. Daredevil wallhack identifies who to finish.",
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Wall control for poke phase."},{p:"Gabe",h:"Magneto",r:"tank",n:"Shield during poke. Aggressive for dive."},{p:"Tristen",h:"Spider-Man",r:"dps",n:"78.6% WR. Pokes then dives."},{p:"Jace",h:"Daredevil",r:"dps",n:"72% WR. Wall-hack IDs dive targets."},{p:"Ayden",h:"Rocket",r:"heal",n:"Planet X Pals w/ Groot."},{p:"Raquel",h:"C&D",r:"heal",n:"Teleport for dive follow-up. C&D priority."}],tu:["Planet X Pals (Groot+Rocket)"],alt:"Tristen to Hela for more poke.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"C&D",w:"Deny enemy heals."}],s:[{h:"Magneto",w:"Bubble protects poke phase."},{h:"Spider-Man",w:"Dive finisher. Losing SM removes the kill option."}]}},
{name:"HYBRID: Poke/Brawl",tag:"Range to Rush",color:C.gold,desc:"Poke to soften, Thor rushes when enemies are low. Begin's 70% WR comes from picking his moments.",
lineup:[{p:"Begin",h:"Thor",r:"tank",n:"70% WR. Pokes then engages when low."},{p:"Gabe",h:"Magneto",r:"tank",n:"Shield for poke. Push forward for brawl."},{p:"Tristen",h:"Hela",r:"dps",n:"Poke softens targets for Thor."},{p:"Zach",h:"Wolverine",r:"dps",n:"Cleanup with Thor."},{p:"Ayden",h:"Gambit",r:"heal",n:"AoE heals. Explosive Entanglement w/ Mag."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority."}],tu:["Explosive Entanglement (Gambit+Magneto)"],alt:"Jace Daredevil for poke. Jace Blade for melee maps.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Gambit",w:"Enemy Gambit ult counters brawl push."}],s:[{h:"Thor",w:"The comp IS Thor's engage."},{h:"Magneto",w:"Enables poke-to-brawl transition."}]}},
{name:"ANTI-3 SUPP",tag:"Burst the Healers",color:"#ff006e",desc:"Counter triple-support. Groot + Moon Knight ult combo = guaranteed fight win. Thor burst through healing. Rocket damage boost + Thor ult one-shots 300HP healers.",
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Wall isolates healers. Ult combo w/ MK."},{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Ult COUNTERS enemy C&D."},{p:"Zach",h:"Thor",r:"tank",n:"83.3% WR. Awakening Rune bursts through healing."},{p:"Tristen",h:"Moon Knight",r:"dps",n:"Ult combo w/ Groot = guaranteed fight win. Practice required."},{p:"Ayden",h:"Rocket",r:"heal",n:"C.Y.A. boost + Thor ult = one-shot 300HP healers."},{p:"Raquel",h:"C&D",r:"heal",n:"C&D priority. Magneto bubble protects ult."}],tu:["Planet X Pals (Groot+Rocket)","C.Y.A. Damage Boost (Rocket → Thor)"],alt:"Tristen not on MK: Jace Daredevil (loses ult combo). T-Money MK if practiced.",
bs:{b:[{h:"Elsa Bloodstone",w:"Always."},{h:"Deadpool (V)",w:"Always."},{h:"Gambit",w:"Remove strongest enemy support."}],s:[{h:"Groot",w:"Groot+MK combo IS the comp."},{h:"Magneto",w:"Bubble + ult counters enemy C&D."}]}},
];
...
s:[{h:"Thor",w:"Begin's best. 70% WR. 66.7% across 33g on second acct."},{h:"Magneto",w:"Gabe's 71.4%. MUST ACTUALLY PLAY IN TOURNAMENT."},{h:"C&D",w:"Multiple pilots. Save denies enemy AND secures your heals."},{h:"Venom",w:"Ayden's only dive tank option."},{h:"Groot",w:"Begin's second tank. 77.8% WR on second acct."},{h:"Daredevil",w:"Jace's 72% WR 25g. S-tier info DPS. Save secures permanent wallhack advantage."}]};
...
<Sec title="BAN-SAVE STRATEGY" titleColor={C.gold}><p style={{color:C.dim,fontSize:F.sm,lineHeight:1.7,margin:0}}>{BANS.g}</p></Sec>
...
<p style={{color:C.dim,fontSize:F.sm,lineHeight:1.7,margin:"0 0 14px"}}>{BANS.g}</p>
...
const tabs=[{id:"stats",l:"Stats"},{id:"tourney",l:"Tournament"},{id:"comps",l:"Comps"},{id:"maps",l:"Maps"},{id:"feedback",l:"Intel"},{id:"learn",l:"Learns"},{id:"info",l:"Rules"},{id:"draft",l:"Draft Sim"},{id:"roles",l:"Roles"},{id:"meta",l:"Meta"},{id:"player",l:"Player"},{id:"changelog",l:"Log"}];
