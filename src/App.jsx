...
ourComp:"POKE: Begin Groot + Gabe Magneto + Tristen Hela + Zach Daredevil + Ayden Rocket + Sam C&D. Tournament showed: Iron Man and Thing failed here (0.20 and 1.25 KDA). Don't repeat that."},
...
ourComp:"HYBRID Poke/Dive: Begin Groot + Gabe Magneto + Tristen Spider-Man + Zach Daredevil + Ayden Rocket + Sam C&D. Spider-Man plays poke-phase on rooftops, then dives enclosed sections."},
...
ourComp:"POKE: Begin Groot + Gabe Magneto + Tristen Hela + Zach Daredevil + Ayden Rocket + Sam C&D. ABSOLUTELY DO NOT run Moon Knight, Emma, or melee DPS here — tournament proved it."},
...
ourComp:"HYBRID: Begin Thor (brawl sections) or Groot (poke sections) — consider mid-match hero swap. Gabe Magneto + Tristen Hela (outdoor) / Psylocke (indoor) + Zach Daredevil + Ayden Rocket + Sam C&D."},
...
ourComp:"POKE: Begin Groot + Gabe Magneto + Tristen Hela + Zach Daredevil + Ayden Rocket + Sam C&D."},
...
ourComp:"HYBRID: Begin Groot + Gabe Magneto + Tristen Spider-Man (dive flanks) + Zach Daredevil (info) + Ayden Rocket + Sam C&D."},
...
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Wall control. Planet X Pals w/ Rocket. 77.8% WR on second account."},{p:"Gabe",h:"Magneto",r:"tank",n:"71.4% WR. Metal Bulwark. MUST be default tournament pick."},{p:"Tristen",h:"Hela",r:"dps",n:"Primary ranged hitscan. Goddess of Death ult = 10s aerial AoE."},{p:"Zach",h:"Daredevil",r:"dps",n:"Info + sustained poke. 83.3% Thor WR but Daredevil fits poke better."},{p:"Ayden",h:"Rocket",r:"heal",n:"Planet X Pals w/ Groot."},{p:"Sam",h:"C&D",r:"heal",n:"55.6% WR. Primary healer."}],tu:["Planet X Pals (Groot+Rocket)","Explosive Entanglement (Mag+Gambit — flex)"],alt:"Groot banned: Begin Thor. Mag banned: Gabe Strange (57.7%)."},
...
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Solo tank anchor. Wall control sustains poke without needing a second tank."},{p:"Tristen",h:"Hela",r:"dps",n:"Primary poke DPS."},{p:"Zach",h:"Daredevil",r:"dps",n:"Info + sustained damage."},{p:"Ayden",h:"Jeff",r:"heal",n:"57.9% WR, 10.86 KDA — best healer stats on roster."},{p:"Sam",h:"C&D",r:"heal",n:"55.6% WR."},{p:"Raquel",h:"White Fox",r:"heal",n:"IF ready. Kumiho w/ Luna if available. Otherwise Raquel on C&D, Sam on Rocket."}],tu:["Planet X Pals (Groot+Jeff if applicable)"],alt:"Raquel not ready on WF: Raquel C&D + Sam Rocket for Planet X Pals."},
...
lineup:[{p:"Begin",h:"Groot",r:"tank",n:"Wall control for poke phase."},{p:"Gabe",h:"Magneto",r:"tank",n:"Shield during poke. Can flex to aggressive positioning for dive phase."},{p:"Tristen",h:"Spider-Man",r:"dps",n:"78.6% WR. Pokes from rooftops, dives when target is low."},{p:"Zach",h:"Daredevil",r:"dps",n:"Wall-hack identifies dive targets. Info is the bridge between poke and dive."},{p:"Ayden",h:"Rocket",r:"heal",n:"Planet X Pals w/ Groot."},{p:"Sam",h:"C&D",r:"heal",n:"Teleport repositions for dive follow-up."}],tu:["Planet X Pals (Groot+Rocket)"],alt:"Tristen to Hela for more consistent poke if Spider-Man dives aren't converting."},
...
s:[{h:"Thor",w:"Begin's best. 70% WR. 66.7% across 33g on second acct."},{h:"Magneto",w:"Gabe's 71.4%. MUST ACTUALLY PLAY IN TOURNAMENT."},{h:"C&D",w:"Multiple pilots. Lock denies enemy AND secures your heals."},{h:"Venom",w:"Ayden's only dive tank option."},{h:"Groot",w:"Begin's second tank. 77.8% WR on second acct."}]};
...
const tabs=[{id:"stats",l:"Stats"},{id:"tourney",l:"Tournament"},{id:"comps",l:"Comps"},{id:"maps",l:"Maps"},{id:"bans",l:"Bans"},{id:"feedback",l:"Intel"},{id:"learn",l:"Learns"},{id:"info",l:"Rules"},{id:"draft",l:"Draft Sim"},{id:"roles",l:"Roles"},{id:"meta",l:"Meta"}];
...
{tab==="draft"&&<DraftTab/>}{tab==="roles"&&<RoleTab/>}{tab==="meta"&&<MetaTab/>}
</div></div>}
